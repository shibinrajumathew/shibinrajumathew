...
🏢 **[vveeo.com](https://vveeo.com)** &nbsp;|&nbsp; 💼 **[LinkedIn](https://linkedin.com/in/shibinrajumathew)** &nbsp;|&nbsp; 🏆 **[LeetCode](https://leetcode.com/u/shibinrajumathew/)**
...
I build and run production systems end to end, from requirements gathering through architecture, delivery, and monitoring. My independent career began in late 2019 building custom business websites. As the client base grew, I registered my practice as Vveeo, an Udyam (MSME) micro enterprise, in March 2022 and expanded into ERP, cloud migration, and DevOps work for clients across the Middle East, USA, and India.

Before going independent, I worked full time at Mozanta Technologies, building backend systems as part of a larger engineering team.
...
- Built and maintained RESTful APIs across 2 to 3 microservices supporting recharge transactions and reward logic, including spin wheel rewards, working within the client's 4 person backend team
...
**Business Websites & Web Platforms** *(Mar 2022 to Present)*
- Continued delivering and maintaining custom business websites for clients across Retail, Real Estate, Homestay, Services, and Software Services sectors
...
- Maintained long term client relationships spanning 3 to 5 years, with ongoing support and enhancements

*Stack: PHP, HTML, CSS, WordPress, VitePress, Cloud Hosting, Claude, WCAG/ARIA*

---

### Independent Software Consultant (Nov 2019 to Feb 2022)
**Remote | Clients in Middle East and India**

- Delivered 6 to 10 custom business websites across Retail, Real Estate, Homestay, Services, and Software Services sectors
...
- Grew the client base to the point of formalizing the practice as Vveeo in March 2022

*Stack: PHP, HTML, CSS, WordPress, VitePress, Cloud Hosting*

---

### Mozanta Technologies (2018 to 2019)
*now Valoriz Digital, India*

**Full Stack Software Developer** *(Oct 2018 to Oct 2019)*

Worked in a cross-functional engineering team building ecommerce and order management products on the MERN stack and Java Spring Boot, collaborating closely with testers and senior engineers under code review.

- **Order Management System (OMS).** Built new features and fixed bugs across MERN stack modules and Spring Boot microservices. Implemented a real time order tracking feature and improved order processing efficiency by 30%, keeping all fixes documented and aligned with project coding standards.
- **Carrier Management System.** Built carrier management features with React, Node.js, Express.js, and MongoDB, improving delivery efficiency by 30%.
- **SFCC to OMS Order Sync (PIM module).** Developed an integration bridge between Salesforce Commerce Cloud (SFCC) and the OMS, keeping order information consistent in both systems whenever either side changed.
- **Loyalty App.** Integrated loyalty card allocation and verification into a client's ecommerce module through REST APIs, built with React.js, Express.js, and MongoDB.
- **Artic.** Built a streamlined order management platform with Salesforce style features for startups, giving small companies the essential order workflows without enterprise complexity (React.js, Express.js, MongoDB).
- **Singleton, Ecommerce Lite.** Developed a lightweight ecommerce app with Java Spring Boot and MongoDB so startups could set up a store quickly with only the essential features.
...
*Stack: React.js, Node.js, Express.js, MongoDB, Java Spring Boot, Microservices, REST APIs, Salesforce Commerce Cloud (SFCC)*
...
- **Business Ownership.** I run my own consultancy, handling client acquisition, scoping, delivery, and long term support.
...
- **Master's Degree (MCA)**, Computer Applications, University of Kerala, Thiruvananthapuram, 2018
...
- 📱 **Phone:** +91-9048620781
- 🏢 **Company:** [vveeo.com](https://vveeo.com)
